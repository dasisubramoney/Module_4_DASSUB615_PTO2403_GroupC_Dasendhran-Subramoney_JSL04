...
switch(userPreference) {
    case 'Sugar-free':
        console.log(`The User prefers sugar free monsters`);
        break;
    case 'Regular':
        console.log(`The User prefers regular monsters`);
        break;
    default:
        console.log(`The User prefers regular monsters`);
}
...
const resultCansleft = (cansLeft < 5) ? "Time to restock!" :  "We're stocked!";
console.log(resultCansleft);
...
const resultTemp = (currentTemp <= 5) ? "Chilled to perfection!" :  "Needs a cooler!";
